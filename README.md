...
## 👋 Hey! Here's what this project is about

This is one of my first real data science projects! I took a messy Airbnb dataset from Kaggle with **74,111 listings** across 6 US cities and tried to clean it up and find some interesting patterns in the data.

I'm still learning Python and Pandas so I kept things simple — but I think the findings are actually pretty cool!
...
Unverified hosts: $163/night vs Verified hosts: $159/night. I thought verified hosts would charge more but it's basically the same. Interesting!

---

## 📊 Charts

I made a chart for each finding using Matplotlib. Check the notebook to see them all!
...
3. Download the dataset from [Kaggle](https://www.kaggle.com/datasets/sankalp102/air-bnb) and drop `Airbnb_Data.csv` into the project folder
...
│
├── airbnb_eda.ipynb       # The main notebook with all the code
├── Airbnb_Data.csv        # Dataset (download from Kaggle link above)
└── README.md              # This file!
```
...
**Your Name**  
Aspiring Data Scientist — currently learning Python and Pandas!  
[LinkedIn](https://linkedin.com/in/yourprofile) | [GitHub](https://github.com/yourusername)

---

*First portfolio project! Dataset from Kaggle. Feedback welcome 🙂*
